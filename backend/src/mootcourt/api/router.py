...
from mootcourt.api.routes.case_admin import router as case_admin_router
from mootcourt.api.routes.organization_admin import router as organization_admin_router
...
api_router.include_router(case_admin_router)
